...
const CommunityPage = () => {
  ...
  const addCommentToSelectedPost = () => {
    ...
    const newlySelected = updatedPosts.find((p) => p.id === selectedPost.id);
    setSelectedPost(newlySelected);
    setNewComment("");
  };
        ...
        <div className="px-5 space-y-6">
          {sortedPosts.map((post) => (
            <div
              ...
              className="bg-white rounded-3xl shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer"
            >
              {/* 미디어 영역 */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl">
            ...
            {selectedPost.mediaUrl ? (
              ...
              <div className="h-56 bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center">
            ...
            <div className="p-6">
              ...
              {Array.isArray(selectedPost.commentsList) &&
                  ...
                  <div className="mt-6">
                    ...
                    <div className="space-y-4">
                      {selectedPost.commentsList.map((comment) => (
                        ...
                        >
                          <div className="w-9 h-9 bg-gradient-to-br from-pink-100 to-purple-100 rounded-full flex items-center justify-center text-base flex-shrink-0">
                            {comment.avatar}
                          </div>
                          <div className="flex-1">
            ...
            <div className="p-4 border-t border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  className="flex-1 p-3 border-2 border-gray-200 rounded-xl focus:border-pink-300 focus:outline-none text-sm"
                />
                <button
                  onClick={addCommentToSelectedPost}
                  disabled={!newComment.trim()}
                  className="px-4 py-2 bg-pink-500 text-white rounded-xl text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  등록
                </button>
              </div>
